    ...
    const handleSubmit = async (e)=>{
        ...
        try {
          ...
          if(data.success){
            ...
            axios.defaults.headers.common['Autgorization'] = data.token;
          } 
          else{
      ...
      <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow-xl shadow-primary/15 rounded-lg'>
        <div className='flex flex-col items-center justify-center'>
            ...
            <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
                ...
                <button type="submit" className='w-full py-3 font-medium bg-primary text-white rounded cursor-pointer hover:bg-primary/90 transiistion-all'>Login</button>
            </form>
        </div>
      </div>
    </div>
